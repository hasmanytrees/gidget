...
Gidget allows for settings in the Sinatra style.  Settings can be set in your config.ru during creation of the Gidget server:
...
Settings can then be accessed from within views by using the settings object:
